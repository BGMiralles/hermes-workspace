...
async function buildEntry(
  ...
  return {
    ...
    lastCheckIn: runtime.lastCheckIn,
    lastSummary: runtime.lastSummary,
    lastRealSummary: (runtime as Record<string, unknown>).lastRealSummary as string | null ?? null,
    nextAction: runtime.nextAction,
    lastResult: runtime.lastResult,
    lastRealResult: (runtime as Record<string, unknown>).lastRealResult as string | null ?? null,
